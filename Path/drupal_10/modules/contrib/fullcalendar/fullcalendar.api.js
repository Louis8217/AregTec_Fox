    ...
    const options = $.extend(
      {
        ...
        // Ajouter l'événement eventClick
        eventClick: function(info) {
          // Redirection vers la page de réservation avec l'ID de l'événement
          if (info.id) {
            const reservationUrl = '/reservation/' + info.id; // URL personnalisée
            window.location.href = reservationUrl;
          } else {
            alert('Erreur : impossible de réserver ce créneau.');
          }
        },
      },
      settings,
